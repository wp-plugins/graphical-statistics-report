...
function graphic_report_admin_options() 
{
	...
	//----------------------------------------------------------------------------------------------------------
	?>
    <br>Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>.<br>
    Thanks to fusion Charts team for this SWF graph.<br>
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/graphical-statistics-report/'>Click here</a> to post suggestion/comments about this plugin.<br>
	<a target="_blank" href='http://www.gopiplus.com/work/plugin-list/'>Click here</a> to see all my plugin.<br>
	<a target="_blank" href='http://www.gopiplus.com/work/'>Click here</a> to download my other plugin.<br><br>
    <?php
}
